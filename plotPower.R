...
nullMax <- 12.0 #a reasonable upper bound
times <- round(seq(150,700,by=50)/0.9)
...
a_ply(.data=comb, .parallel=FALSE, .margins=1, .fun=function(r) {
  system2(command="optseq2", args=paste0("--ntp ", r$t, " --tr 0.9 --psdwin 0 20 1.0 --ev evt1 ", trialLength, " ", r$n,
                                         " --nkeep 5 --tnullmin ", nullMin, " --tnullmax ", nullMax, " --o SPOTT_t", r$t, "_n", r$n, "_p", r$p,
...
##optseq2 --ntp 267 --tr 0.9 --psdwin 0 21 1 --ev evt1 3 60 --nkeep 8 --o clock_t264_p38 --nsearch 5000000 --polyfit 2 --sum summary_t264_p38.log --tnullmax 12 --tnullmin 1
